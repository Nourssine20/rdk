 ...
 */
package com.automatics.devicemanager.connection.auth;
...
public class CredentialFactory {
     ...
     * @throws Exception
     */
    public synchronized Credential getServerCredentials(String machineName) throws Exception {
	Credential ret = null;
	ret = (Credential) SERVER_DETAILS.get(machineName);

	if (ret == null) {
	    throw new Exception("Unable to find " + machineName + " in the credentials file.");
